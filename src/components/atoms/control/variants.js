...
const control = cnv({
  base: 'group inline-flex w-full cursor-pointer items-center justify-between rounded-sm border border-transparent px-sm font-medium transition-colors [--outline-color:theme(colors.main)] placeholder:font-normal placeholder:text-content/75 focus:outline-[--outline-color] disabled:cursor-not-allowed disabled:opacity-50',
  variants: {
