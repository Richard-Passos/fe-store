...
const SheetOverlay = ({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      'data-closed:animate-out data-closed:fade-out data-open:animate-in data-open:fade-in fixed inset-0 z-50 bg-main/80 backdrop-blur-sm',
      className,
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cnv(
  {
  base: 'fixed z-50 gap-4 bg-main p-6 shadow-lg transition ease-in-out data-open:animate-in data-closed:animate-out data-closed:duration-300 data-open:duration-500',
    variants: {
      side: {
